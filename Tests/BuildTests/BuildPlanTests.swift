...
//        XCTAssertTrue(diagnostics.diagnostics.contains(where: { ($0.message.data is PkgConfigHintDiagnostic) }))
    ...
    func testBinaryTargets() throws {
        ...
        XCTAssertMatch(libraryBasicArguments, [.anySequence, "-L", "/path/to/build/debug", .anySequence])
        ...
        XCTAssertMatch(exeCompileArguments, [.anySequence, "-L", "/path/to/build/debug", .anySequence])
